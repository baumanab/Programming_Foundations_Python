...
full_metal_jacket = media.Movie("Full Metal Jacket", "A marine journalist during the vietnam coflict",
...
ratatouille = media.Movie("Ratatoullie", "Storyline",
...
movies = [toy_story, avatar, full_metal_jacket, school_of_rock, ratatouille,
